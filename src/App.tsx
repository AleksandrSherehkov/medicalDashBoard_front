...
import { AnimatedLogo } from './shared/components/AnimatedLogo/AnimatedLogo';
    ...
    <Routes>
      ...
      <Route path="/" element={<SharedLayout />}>
        ...
        <Route
          path="orders"
          element={
            <ProtectedRoute component={OrdersPage} redirectTo="/login" />
          }
        />
        <Route
          path="products"
          element={
            <ProtectedRoute component={AllProductsPage} redirectTo="/login" />
          }
        />
        <Route
          path="suppliers"
          element={
            <ProtectedRoute component={SuppliersPage} redirectTo="/login" />
          }
        />
        <Route
          path="customers"
          element={
            <ProtectedRoute component={CustomersPage} redirectTo="/login" />
          }
        />
      </Route>
